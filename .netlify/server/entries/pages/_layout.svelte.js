import { g as get_store_value, c as create_ssr_component, e as escape, a as add_attribute, b as compute_slots, v as validate_component } from "../../chunks/ssr.js";
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return ` ${$$result.head += `<!-- HEAD_svelte-17jkpha_START -->${$$result.title = `<title>Mr. Mixer</title>`, ""}<!-- HEAD_svelte-17jkpha_END -->`, ""}  ${validate_component(AppShell, "AppShell").$$render($$result, {}, {}, {
    default: () => {
      return ` <div class="flex flex-col min-h-screen">${validate_component(AppBar, "AppBar").$$render($$result, {}, {}, {
        trail: () => {
          return ` <div class="desktop-nav sm:hidden" data-svelte-h="svelte-j0rdz7"><a class="btn btn-sm variant-ghost-surface " href="../shop" target="_self" rel="noreferrer">Shop</a> <a class="btn btn-sm variant-ghost-surface" href="../shipping" target="_self" rel="noreferrer">Shipping</a> <a class="btn btn-sm variant-ghost-surface" href="https://www.tiktok.com/@mr..mixer" target="_blank" rel="noreferrer">TikTok</a> <a class="btn btn-sm variant-ghost-surface" href="https://www.facebook.com/Mrmixer316" target="_blank" rel="noreferrer">Facebook</a> <a class="btn btn-sm variant-ghost-surface" href="https://www.instagram.com/mr._mixer_/" target="_blank" rel="noreferrer">Instagram</a></div>`;
        },
        lead: () => {
          return `<main class="flex-grow" data-svelte-h="svelte-1o36waf"><a href="/" class="btn hover:variant-soft"><strong class="text-xl uppercase">Mr. Mixer</strong></a></main>`;
        }
